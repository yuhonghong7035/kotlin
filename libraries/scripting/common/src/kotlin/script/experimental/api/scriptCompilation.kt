...
/**
 * The list of sources that should be compiled along with the script
 */
val ScriptCompilationConfigurationKeys.requireSources by PropertiesCollection.key<List<SourceCode>>()
