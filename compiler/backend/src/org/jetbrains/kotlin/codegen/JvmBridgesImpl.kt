...
class DescriptorBasedFunctionHandleForJvm(
    ...
    override fun createHandleForOverride(override: FunctionDescriptor) =
        DescriptorBasedFunctionHandleForJvm(override, jvmTarget)
...
/**
 * @return true for a methods annotated with @JvmDefault or @PlatformDependent
 */
