    ...
    if (this is A5) {
        if (<!SENSELESS_COMPARISON!>this != null<!>) {
            ...
            apply {
                ...
                equals(this)
                test()
                <!DEBUG_INFO_EXPRESSION_TYPE("{A5 & T?!!}"), DEBUG_INFO_EXPRESSION_TYPE("{A5 & T?!!}")!>this<!>.equals(this)
    ...
    if (this is A6?) {
        if (this != null) {
            ...
            apply {
                ...
                equals(this)
                test()
                <!DEBUG_INFO_EXPRESSION_TYPE("{A6 & T?!!}"), DEBUG_INFO_EXPRESSION_TYPE("{A6 & T?!!}")!>this<!>.equals(this)
    ...
    if (x is A7?) {
        if (x != null) {
            ...
            x.apply {
                ...
                equals(this)
                test()
                <!DEBUG_INFO_EXPRESSION_TYPE("{A7 & T!!}"), DEBUG_INFO_EXPRESSION_TYPE("{A7 & T!!}")!>this<!>.equals(this)
    ...
    if (this != null) {
        if (this is A8?) {
            ...
            apply {
                ...
                equals(this)
                test()
                <!DEBUG_INFO_EXPRESSION_TYPE("{A8 & T!!}"), DEBUG_INFO_EXPRESSION_TYPE("{A8 & T!!}")!>this<!>.equals(this)
    ...
    if (this is A11?) {
        if (this != null) {
            ...
            apply {
                ...
                equals(this)
                test()
                <!DEBUG_INFO_EXPRESSION_TYPE("{A11 & T?!!}"), DEBUG_INFO_EXPRESSION_TYPE("{A11 & T?!!}")!>this<!>.equals(this)
...
fun <T : A24<in T>> A24<T>?.case_24() {
    if (this != null) {
        ...
        <!DEBUG_INFO_IMPLICIT_RECEIVER_SMARTCAST!>apply<!> {
            ...
            equals(this)
            test()
            <!DEBUG_INFO_EXPRESSION_TYPE("A24<T>"), DEBUG_INFO_EXPRESSION_TYPE("A24<T>")!>this<!>.equals(this)
...
fun <T : A25<out T>> A25<T>?.case_25() {
    if (this != null) {
        ...
        <!DEBUG_INFO_IMPLICIT_RECEIVER_SMARTCAST!>apply<!> {
            ...
            equals(this)
            test()
            <!DEBUG_INFO_EXPRESSION_TYPE("A25<T>"), DEBUG_INFO_EXPRESSION_TYPE("A25<T>")!>this<!>.equals(this)
...
fun <T : A26<T>> A26<in T>?.case_26() {
    if (this != null) {
        ...
        apply {
            ...
            equals(this)
            test()
            <!DEBUG_INFO_EXPRESSION_TYPE("A26<in T>"), DEBUG_INFO_EXPRESSION_TYPE("A26<in T>")!>this<!>.equals(this)
...
fun <T : A27<T>> A27<out T>?.case_27() {
    if (this != null) {
        ...
        apply {
            ...
            equals(this)
            test()
            <!DEBUG_INFO_EXPRESSION_TYPE("A27<out T>"), DEBUG_INFO_EXPRESSION_TYPE("A27<out T>")!>this<!>.equals(this)
...
fun <T : A28<in T>> A28<out T>?.case_28() {
    if (this != null) {
        ...
        apply {
            ...
            equals(this)
            test()
            <!DEBUG_INFO_EXPRESSION_TYPE("A28<out T>"), DEBUG_INFO_EXPRESSION_TYPE("A28<out T>")!>this<!>.equals(this)
...
fun <T : A29<out T>> A29<in T>?.case_29() {
    if (this != null) {
        ...
        apply {
            ...
            equals(this)
            test()
            <!DEBUG_INFO_EXPRESSION_TYPE("A29<in T>"), DEBUG_INFO_EXPRESSION_TYPE("A29<in T>")!>this<!>.equals(this)
...
fun <T : A30<in T>> A30<in T>?.case_30() {
    if (this != null) {
        ...
        apply {
            ...
            equals(this)
            test()
            <!DEBUG_INFO_EXPRESSION_TYPE("A30<in T>"), DEBUG_INFO_EXPRESSION_TYPE("A30<in T>")!>this<!>.equals(this)
...
fun <T : A31<out T>> A31<out T>?.case_31() {
    if (this != null) {
        ...
        apply {
            ...
            equals(this)
            test()
            <!DEBUG_INFO_EXPRESSION_TYPE("A31<out T>"), DEBUG_INFO_EXPRESSION_TYPE("A31<out T>")!>this<!>.equals(this)
...
fun <T> A33<T, *, T, *, T, *, T>?.case_33() {
    if (this != null) {
        ...
        apply {
            ...
            equals(this)
            test()
            <!DEBUG_INFO_EXPRESSION_TYPE("A33<T, out kotlin.Any?, T, out kotlin.Any?, T, out kotlin.Any?, T>"), DEBUG_INFO_EXPRESSION_TYPE("A33<T, out kotlin.Any?, T, out kotlin.Any?, T, out kotlin.Any?, T>")!>this<!>.equals(this)
...
fun <T> A34<out T>?.case_34() {
    if (this != null) {
        ...
        apply {
            ...
            equals(this)
            test()
            <!DEBUG_INFO_EXPRESSION_TYPE("A34<out T>"), DEBUG_INFO_EXPRESSION_TYPE("A34<out T>")!>this<!>.equals(this)
...
fun <T> A35<in T>?.case_35() {
    if (this != null) {
        ...
        apply {
            ...
            equals(this)
            test()
            <!DEBUG_INFO_EXPRESSION_TYPE("A35<in T>"), DEBUG_INFO_EXPRESSION_TYPE("A35<in T>")!>this<!>.equals(this)
...
fun <T> A36<out T>?.case_36() {
    if (this != null) {
        ...
        apply {
            ...
            equals(this)
            test()
            <!DEBUG_INFO_EXPRESSION_TYPE("A36<out T>"), DEBUG_INFO_EXPRESSION_TYPE("A36<out T>")!>this<!>.equals(this)
...
fun <T> A39<in T, out T>?.case_39() {
    if (this != null) {
        ...
        apply {
            ...
            equals(this)
            <!DEBUG_INFO_EXPRESSION_TYPE("A39<in T, out T>"), DEBUG_INFO_EXPRESSION_TYPE("A39<in T, out T>")!>this<!>.equals(this)
        }
        also {
...
fun <T> A40<in T, in T>?.case_40() {
    if (this != null) {
        ...
        apply {
            ...
            equals(this)
            <!DEBUG_INFO_EXPRESSION_TYPE("A40<in T, in T>"), DEBUG_INFO_EXPRESSION_TYPE("A40<in T, in T>")!>this<!>.equals(this)
        }
        also {
...
fun <T> A44<in T, *, out T, *, T, *, in T>?.case_44() {
    if (this != null) {
        ...
        apply {
            ...
            equals(this)
            test()
            <!DEBUG_INFO_EXPRESSION_TYPE("A44<in T, out kotlin.Any?, out T, out kotlin.Any?, T, out kotlin.Any?, in T>"), DEBUG_INFO_EXPRESSION_TYPE("A44<in T, out kotlin.Any?, out T, out kotlin.Any?, T, out kotlin.Any?, in T>")!>this<!>.equals(this)
